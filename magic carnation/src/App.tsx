...
const App = () => {
  ...
  const handleCloseOnboarding = () => {
    // لا نحفظ في localStorage حتى تظهر الشاشة في كل مرة
    setShowOnboarding(false);
  };

  useEffect(() => {
    // أظهر شاشة الترحيب في كل مرة يفتح فيها الموقع
  ...
  if (showOnboarding) {
    console.log('🎯 Showing MobileWelcome screen!');
    return <MobileWelcome onClose={handleCloseOnboarding} />;
  }
      ...
      <div className={`min-h-screen bg-gray-900 text-white ${language === 'ar' ? 'font-arabic' : 'font-sans'}`} dir={language === 'ar' ? 'rtl' : 'ltr'}>
        ...
        <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
          ...
          <div className="group relative">
            <button 
              onClick={() => { setShowAdminModal(true); setPendingAdminPage('admin-dashboard'); }}
            ...
            <div className="flex items-center justify-between h-16">
              ...
              <div className="hidden md:block">
                <div className="ml-10 flex items-baseline space-x-8">
                  ...
                  <button onClick={() => { setShowAdminModal(true); setPendingAdminPage('admin-dashboard'); }} className="text-gray-300 hover:text-blue-400 transition-colors font-bold">لوحة التحكم</button>
                  <a 
                    href="#portfolio" 
                    onClick={(e) => {
                      e.preventDefault();
          ...
          {isMenuOpen && (
            <div className="md:hidden bg-black/95 backdrop-blur-md">
              <div className="px-2 pt-2 pb-3 space-y-1">
                ...
                <button onClick={() => { setShowAdminModal(true); setPendingAdminPage('admin-dashboard'); setIsMenuOpen(false); }} className="block w-full text-right px-3 py-2 text-blue-400 font-bold">لوحة التحكم</button>
                <a 
                  href="#portfolio" 
                  onClick={(e) => {
                    e.preventDefault();
        ...
        <section className="relative min-h-screen flex items-center justify-center pt-16">
          ...
          <div className="relative z-10 text-center max-w-6xl mx-auto px-4">
            ...
            <p className="text-base sm:text-xl md:text-2xl text-gray-400 mb-8 max-w-3xl mx-auto">
              نحن شركاء TikTok الرسميون، تأسست شركتنا عام 2023 في طنجة – المغرب، بهدف تمكين صُنّاع المحتوى من إطلاق كامل إمكاناتهم الإبداعية. نعمل على اكتشاف، تطوير، وصناعة نجوم الغد من خلال دعم المواهب الشابة وتحويلها إلى محترفين في إنتاج المحتوى الإبداعي والجذاب. بفريقنا المتخصص وشراكاتنا الاستراتيجية، نسعى إلى أن نكون الوكالة الرائدة في مجال الترفيه وصناعة المحتوى في منطقة الشرق الأوسط وشمال إفريقيا، واضعين الابتكار والجودة في صميم كل ما نقوم به.
            </p>
